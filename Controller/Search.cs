...
namespace BloodGuardian.Controller
{
    ...
    public class Search : ISearch
    {
        ...
        public void SearchBloodDonationCamp(Donor d)
        {
            ...
            {
                if (camp.Camp_State.Equals(d.State,StringComparison.InvariantCultureIgnoreCase) && camp.Camp_City.Equals(d.City,StringComparison.InvariantCultureIgnoreCase)) camps.Add(camp);
            }));
