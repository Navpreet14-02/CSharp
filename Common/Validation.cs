...
namespace BloodGuardian.Common
{
    public class Validation
    {
        ...
        public static void ValidateId(string id)
        {
            ...
            int temp;
            if (id.Equals(String.Empty) || !int.TryParse(id, out temp)) throw new InvalidDataException(Message.EnterValidInput);
        ...
        public static void ValidateRole(string role)
        {
            ...
            if (roletaken.Equals((int)Roles.Donor) && roletaken.Equals((int)Roles.BloodBankManager))
            {
