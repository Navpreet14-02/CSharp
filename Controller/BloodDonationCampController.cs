...
namespace BloodGuardian.Controller
{
    ...
    internal class BloodDonationCampController : IAdminBloodDonationCamp, IBloodDonationCamp
    {
        ...
        //public void AdminRemoveBloodDonationCamp(Donor d,int bankid)
        //{
        ...
        //    else
        //    {
        //        var camp = bank.BloodDonationCamps.ElementAtOrDefault(bankid);

        //        RemoveBloodDonationCamps(bank, camp);
        //    }
